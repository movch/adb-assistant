...
final class MainViewController: NSViewController {
    ...
    @IBOutlet weak var toolsTableView: NSTableView!
    ...
    private func bindSidebarViewModel() {
        sidebarViewModel?.devices.bind { [weak self] (devices) in
    ...
    private func bindScreenshotViewModel() {
        let screenshotBinding: (Any) -> () = { [weak self] _ in
    ...
    private func setToolsTableViewVisibility() {
        ...
        self.toolsTableView.isHidden = viewModel.devices.value.count > 0 ? false : true
        self.placeholderLabel.isHidden = !self.toolsTableView.isHidden
    }
